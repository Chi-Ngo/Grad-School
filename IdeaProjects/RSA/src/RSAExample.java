...
public class RSAExample {
    ...
    public static void main(String[] args) {
        ...
        //n = p.multiply(q);
        n = new BigInteger("9013594933187057813");
        ...
        //d = e.modInverse(phi);
        d = new BigInteger("5420920152787448033");
        ...
        BigInteger clear = new BigInteger("78632");
        BigInteger c = clear.modPow(e,n);
        System.out.println("Symmetric key is: " + c);

        BigInteger decrypted = c.modPow(d,n);
        System.out.println("Decrypted key is: " + decrypted);

        BigInteger p1 = new BigInteger("2666318969");
        BigInteger q1 = new BigInteger("3380538877");
        n = p1.multiply(q1);
        BigInteger decrypted1 = c.modPow(d,n);
        System.out.println("Eve found: " + decrypted1);
/*
